...
export default class menu extends Phaser.Scene {
  ...
  create() {
    ...
    if (this.game.config.point2 < this.game.config.point1) {
      ...
      point = Math.round(this.game.config.point1);

      this.text1 = this.add.text(123, 53, this.game.config.winner + ' WIN', { fontSize: '22px', fill: '#0000ff', fontWeight: 'bold' });
      this.text1.setVisible(true);
  
      this.text1 = this.add.text(112, 102, point + ' pts', { fontSize: '16px', fill: '#0000ff', fontWeight: 'bold' });
      this.text1.setVisible(true);
      ...
      point = Math.round(this.game.config.point2);

      this.text1 = this.add.text(123, 53, this.game.config.winner + ' WIN', { fontSize: '22px', fill: '#ff0000', fontWeight: 'bold' });
      this.text1.setVisible(true);
  
      this.text1 = this.add.text(112, 102, point + ' pts', { fontSize: '16px', fill: '#ff0000', fontWeight: 'bold' });
      this.text1.setVisible(true);
