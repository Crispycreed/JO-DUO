...
export default class selection extends Phaser.Scene {
    ...
    update() {
        ...
        if (player.x >= 800 && player.body.onFloor()) {
            ...
            points2 = this.game.config.point1;
            this.game.config.point1 = points2 + points;
            ...
            musique_ambiance.stop();
            this.scene.start("JUMP2");
            this.scene.stop("JUMP1");
        }
    }
}